<script>
	import { stats, goalscorers } from "$lib/shared/stores/season.js";
...
<div class="header">
	...
	<Select
		...
		items = {[
			...
			{ value: "clean-sheets", label: "Clean Sheets", group: "Goalkeeping" },
			{ value: "penalties-saved", label: "Penalties Saved", group: "Goalkeeping" },
		]}
